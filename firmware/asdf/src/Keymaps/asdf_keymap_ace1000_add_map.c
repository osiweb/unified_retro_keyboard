...
const FLASH ace1000_keycode_matrix_t ace1000_ctrl_matrix = {
    ...
    [6] = { ACE_KEY_CTRL_0, ACE_KEY_CTRL_P, ACE_KEY_CTRL_SEMI, ACE_KEY_CTRL_SLASH, ACE_KEY_CTRL_7,
            ACTION_FN_10, /* ID-message hook trigger; mirrors the classic/apple2 convention */
            ACE_KEY_CTRL_1, ACE_KEY_CTRL_GT,  },
